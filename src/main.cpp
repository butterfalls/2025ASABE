...
//如果没记错的话应该是黑1白0，然后八路循迹是从左到右1，2，3，4，5，6，7，8,3;4;5;6就是中间的四个
  if((D3==0)&&(D4==1)&&(D5==1)&&(D6==0)){
    forward(50);//就是黑线在中间，这个车前进，因为这是个loop函数所以直接放if
  }

  if ((D3==1)&&(D4==1)&&(D5==1)&&(D6==1)){//3,4,5,6=黑黑黑黑，就是到中间岔路口停下来开始识别+抓取的进程
    leftward(0);//如果需要左移定位
  //与openMV通信，运行抓取和分类程序
...
//读到1还是2 说的是视觉识别返回值是好蛋还是坏蛋
  ...
  //count说的是现在在第几条循环上。
  if (number==4 && count<4){
    /*    if ((D3==0)&&(D4==1)&&(D5==1)&&(D6==0)||(D3==1)&&(D4==1)&&(D5==1)&&(D6==1)){
      backward(50);
    }
    else if ((D3==0)&&(D4==1)&&(D5==1)&&(D6==1)||(D3==1)&&(D4==1)&&(D5==1)&&(D6==1)){
      rightward (100);
    }*/
    revolve_cw(180);//掉头返回
    while ((D4==1)&&(D5==1)){
...
if (count==4){
  ...
  revolve_cw(180);
    ...
    revolve_cw(90);
    while (((D1==0)||(D2==0)||(D3==0))&&((D6==0)||(D7==0)||(D8==0)))//白黑白，继续执行，可能有逻辑上的重复后面可能要改先这样放着
    {
      forward(50);
    }
  if (((D1==1)||(D2==1)||(D3==1))&&((D6==1)||(D7==1)||(D8==1))){//黑黑黑，到收集框的那个位置。
    revolve_cw(90);
  }
  //后退对准
  backward(50);
